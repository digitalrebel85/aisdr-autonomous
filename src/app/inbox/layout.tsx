    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#0a0a0f]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-400 text-sm">Loading AI Inbox...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0f]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Mobile Header */}
        <div className="lg:hidden bg-[#12121a] border-b border-white/10 px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden lg:block absolute top-4 left-4 z-10">
          <Button
            ...
            className="bg-[#12121a] border-white/10 text-white hover:bg-white/10 shadow-lg"
          >
